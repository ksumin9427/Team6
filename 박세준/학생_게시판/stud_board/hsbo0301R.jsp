		...
		<table cellspacing="0" width="600" border="1">
				...
				<td colspan="3">
					<%
						if(bs_fname==null){
							...
							out.println("<p>첨부파일 "+"<a href='hsbo0601W.jsp?fileN="+bs_id+"'>"+bs_fname+"</a></p>");
						}
					%>
				</td>
			</tr>
			...
			<tr>
				<td colspan="4" align="right" >
					<input type="button" value="글수정" onclick="location.href='hsbo0501W.jsp?bs_id=<%= bs_id %>&pageNum=<%= pageNum %>'" >
					&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="button" value="글삭제" onclick="location.href='hsbo0401W.jsp?bs_id=<%= bs_id %>&pageNum=<%= pageNum %>'" >
					&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="button" value="답변글" onclick="location.href='hsbo0201W.jsp?bs_id=<%= bs_id %>&pageNum=<%= pageNum %>'" >
					&nbsp;&nbsp;&nbsp;&nbsp;
