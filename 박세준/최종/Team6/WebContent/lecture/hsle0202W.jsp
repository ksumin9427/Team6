				...
				<div>
					...
					<div class="lmain"
						...
						<table style="width: 100%;"0" overflow:auto">
							...
							<tr class="lhover">
								<td><a class="button"
									onclick="location.href='hsle0204W.jsp?l_no=<%=llb.getL_no()%>&major_no=<%=llb.getMajor_no()%>'">신청</a></td>
								<td><%=llb.getL_no()%></td>
								<td><%=llb.getL_name()%></td>
					...
					<div class="lmain2">
						...
						<div class="lmain2_main">
							<table>
								...
								<tr class="lhover">
									<td><a class="button"
										onclick="location.href='hsle0203W.jsp?l_no=<%=lb.getL_no()%>&major_no=<%=lb.getMajor_no()%>'">삭제</a></td>
									<td><%=lb.getL_no()%></td>
									<td><%=lb.getL_name()%></td>
									<td><%=lb.getL_level()%></td>
									<td><%=lb.getL_unit()%></td>
