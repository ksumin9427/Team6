...
<body>
        <header>
            ...
            <ul class="main-ul">
                <li><a href="../Professor/hpin0101R.jsp">정보</a>
                    <ul class="sub-ul">
                        <li><a href="../Professor/hpin0101R.jsp">개인정보조회</a></li>
                    </ul>
                </li>
                <li><a href="../pro-score/hpsc0101R.jsp">성적</a>
                    <ul class="sub-ul">
                        <li><a href="../pro-score/hpsc0101R.jsp">성적입력 및 수정</a></li>
                    </ul>
                </li>

                <li><a href="../notice/hpno0101R.jsp">게시판</a>
                    <ul class="sub-ul">
                        <li><a href="../notice/hpno0101R.jsp">공지사항</a></li>
