...
<body>
    ...
    <article>
        <section>
            ...
            <tr>
                <td class="news3-1">
                <a href="#"><img src="../images/corona.PNG" width="300px"></a>
                </td>
                <td class="news3-2">
                <a href="#"><img src="../images/p_ground.PNG" width="300px"></a>
                </td>
                 <td class="news3-3">
                <a href="#"><img src="../images/coffee.PNG" width="300px" ></a>
                </td>
                 <td class="news3-4">
                <a href="#"><img src="../images/scream.PNG"width="300px" height="300px"></a>
                </td>
            </tr>
            <tr>
                <td>방역수칙 완벽(공부만해)</td>
            ...
            <img src="../images/for_uni.jpg" width="500" class="introduce">
