...
<body>
       ...
       <!-- <nav> -->
        <ul class="main-ul">
            ...
            <li><a href="hpbo0101R.jsp">게시판</a>
                <ul class="sub-ul">
                    <li><a href="#">공지사항</a></li>
                    <li><a href="hpbo0101R.jsp">자유게시판</a></li>
                </ul>
            </li>
            <li><a href="#">마이페이지</a>
                <ul class="sub-ul">
	...
	<center>
		<h1 align="center" style="margin-left: auto;margin-right: auto;margin-top: 100px;margin-bottom: 0px;">게시판에 등록된 글 목록 보기</h1>
		<table width="600" >
			<tr>
				<td align="right" >
					<a href="hpbo0201W.jsp?pageNum=<%= pageNum %>">글 쓰 기</a>
				</td>
			</tr>
		</table>
