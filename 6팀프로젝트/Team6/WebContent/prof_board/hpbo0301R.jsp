		...
		<table cellspacing="0" width="600" border="1">
			...
			<tr>
				<td colspan="4" align="right" >
					<input type="button" value="글수정" onclick="location.href='hpbo0501W.jsp?bp_id=<%= bp_id %>&pageNum=<%= pageNum %>'" >
					&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="button" value="글삭제" onclick="location.href='hpbo0401W.jsp?bp_id=<%= bp_id %>&pageNum=<%= pageNum %>'" >
					&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="button" value="답변글" onclick="location.href='hpbo0201W.jsp?bp_id=<%= bp_id %>&pageNum=<%= pageNum %>'" >
					&nbsp;&nbsp;&nbsp;&nbsp;
