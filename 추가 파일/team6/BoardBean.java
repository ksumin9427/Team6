...
public class BoardBean {
	...
	public static int pageSize = 10; //한 페이지에 몇 개의 게시글의 보여주기 위한 것
	public static int pageCount = 1; //[총번호개수] [9]까지
	public static int pageNum = 1;//페이지번호
	
	
	public static String pageNumber(int limit) {  //글 목록을 메소드로 호출해서 보여주는 메소드    //limit [이전] [1]...  [다음]에 있는 개수         
		String str="";
		int temp = (pageNum - 1) % limit; //나머지로 생각
		int startPage= pageNum - temp; //pageNum - (pageNum - 1) % limit 시작페이지가 된다
