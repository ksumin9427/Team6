...
<%
	...
	int bs_no=0, bs_hit=0;
	String bs_name="", bs_title="", bs_content="";
...
<body>
	...
	<section>
	<center>
	<div class="outline" width="700">
		<table cellspacing="0" width="700">
	
			<tr align="center">
				<th width="100" height="3" >글번호</td>
			...
			<tr >
				...
				<td colspan="8"><%= bs_title %> </td>
			</tr>
			
			<tr>
				<th width="100" align="center" height="400">내용</td>
				<td colspan="8" rows="25" cols="90"><%= bs_content %> </td>
			</tr>
