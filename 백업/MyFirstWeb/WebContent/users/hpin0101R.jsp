<%@page import="pro.ProBean"%>
<%@page import="pro.ProDBBean"%>
<%@ page language="java" contentType="text/html; charset=EUC-KR"
    pageEncoding="EUC-KR"%>
<%
	int p_no=301; //나중에 교수 번호를 request로 받아서 페이지를 넘어가게할예정입니다.
%>
<html>
<head>
<meta charset="EUC-KR">
        ...
        <section>
            <article>
                <table class="thead">
                    ...
                    <tr>
                        <td colspan="2"><img src="image/zzz.png" width="190px" height="210px"></td>
                    </tr>
                            <%
                            	
                            	ProDBBean prodb = ProDBBean.getinstance();
                            	ProBean pro= prodb.listpro(p_no);
                            	if(pro != null){
                            %>
                    <tr>
