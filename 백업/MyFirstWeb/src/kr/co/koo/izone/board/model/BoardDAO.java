...
public class BoardDAO {
	...
	//게시글 수정 메서드 선언
	public void updateArticle(int b_id, String b_title, String b_content){
		String sql = "update izone_board set board_title=?, board_content=? where board_id=?";
		Connection conn=null;
		PreparedStatement pstmt = null;
	...
	public void deleteArticle(int b_id) {
	...
	public int selectCount() {
		...
		try {
			...
			rs.next();
			num = rs.getInt(1);
			System.out.println("총 개시물의 수 : "+num);
