...
public class pro_Write_Service implements pro_Service {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		dao.write(Integer.parseInt(p_no), p_pwd, p_name, p_birth, p_tel, p_email, p_room, Integer.parseInt(MAJOR_no));
